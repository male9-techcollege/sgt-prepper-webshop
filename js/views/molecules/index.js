...
import { Heading, Div, Ul, Li, Link, LinkWithImageByMariePierreLessard, Paragraph, Label, Input } from "../atoms/index.js";
...
export const HeaderView = () => {
    ...
    */
    ...
    const p = Paragraph();
    const a = Link("/index.htm#/login", "Log ind");
    p.append(a);
    ...
    /* TO DO: instead of a div, this should or could be a link */
    const cartSectionByMariePierreLessard = Div("cartSectionByMariePierreLessard");
